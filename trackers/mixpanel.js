MixpanelTracker = function(options) {
    ...
    mixpanel.init(this.account);
};

MixpanelTracker.prototype.track = function (identifier, parameters) {
  mixpanel.track(identifier, parameters);
};

MixpanelTracker.prototype.identify = function () {
